				...
				<div class="app-body">
					...
					<div class="app-block">
						<div class="app-right-section">
							<div class="app-brand"><span class="highlight">PHPI</span> EM</div>
							<div class="app-info">
						...
						<div class="app-form">
							<div class="form-suggestion">Create an account for free.</div>
							<?= form_open('register'); ?>
								...
								<div class="input-group">
									...
									<input type="password" id="password" name="password" class="form-control" placeholder="Password" aria-describedby="basic-addon3">
								</div>
								<div class="input-group">
								<span class="input-group-addon" id="basic-addon4">
									<i class="fa fa-check" aria-hidden="true"></i></span>
									<input type="password" id="password2" name="password2" class="form-control" placeholder="Confirm Password" aria-describedby="basic-addon4">
								</div>
